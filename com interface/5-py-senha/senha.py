...
try:
    icon_path = resorce_path("senha1.ico")
...
pw_entry = ctk.CTkEntry(root, font=("Helvetica", 24), width=500, justify='center')
...
try:
    create_image = ctk.CTkImage(light_image=Image.open(resorce_path("create.png")), dark_image=Image.open(resorce_path("create.png")), size=(20, 20))
    copy_image = ctk.CTkImage(light_image=Image.open(resorce_path("copy.png")), dark_image=Image.open(resorce_path("copy.png")), size=(20, 20))
    clean_image = ctk.CTkImage(light_image=Image.open(resorce_path("clean.png")), dark_image=Image.open(resorce_path("clean.png")), size=(20, 20))
except Exception as e:
